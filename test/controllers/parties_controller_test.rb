...
class PartiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create party" do
    assert_difference("Party.count") do
      post parties_url, params: { party: { last_name: @party.last_name, party_id: @party.party_id, party_size: @party.party_size, phone: @party.phone, time: @party.time } }
    end
  ...
  test "should update party" do
    patch party_url(@party), params: { party: { last_name: @party.last_name, party_id: @party.party_id, party_size: @party.party_size, phone: @party.phone, time: @party.time } }
